...
<div id="bodycontentcontainer" style="padding:0;">
	...
	<div class="hero">
		<table cellspacing=0 cellpadding=0 class="center"><tr><td align="center" valign="middle">
			<div class="bodymargin">
				<div class="title">Our<span class="textBlue">Designs</span></div>
				<div class="subtitle">Created to Compel.</div>
			</div>
		</td></tr></table>
	...
	<div class="bodymargin"><div class="cushion">
		<div class="grid">
			<div class="panel">
				<a href="/work/cox">
					<div class="image" style="background-image:url(/images/kat.png)"></div>
				</a>
			</div>
			<div class="panel">
